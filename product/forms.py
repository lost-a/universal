...
from .models import Product,phone,Purchase,Blogpost,Itinerary,Erp

class ProductForm(forms.ModelForm):
    class Meta:
        model=Product
        fields=('name','tag_category','description','duration','sale_child','start_loc','map','highlights','city','adventurelevel','adventureloc','reviews','inclusion','order','child','cashback','ques1','ques2','ques3','ques4','ques5','ans1','ans2','ans3','ans4','ans5','additional_info','a_inclusion','overview','rating','regular','sale','category','days','location','state','country','duration_type','loca_city','adventuretype','discount',)

class UpdateForm(forms.ModelForm):
    class Meta:
        model=Product
        fields=('description','rating','regular','sale','category','days','location','state','country','duration_type','loca_city','adventuretype',)

class ErpForm(forms.ModelForm):
    class Meta:
        model=Erp
        fields=('phone','name','email','package','start_date','total_cost','agent','agent_phone','reminder_date','booking_id')
...
class UpdateErpForm(forms.ModelForm):
    class Meta:
        ...
        'payment3_hotel1','paymet3_date_hotel1','mop3_hotel1','comment3_hotel1','payment4_hotel1','paymet4_date_hotel1','mop4_hotel1','comment4_hotel1','dueh1'
        ,'payment1_hotel2','paymet1_date_hotel2','mop1_hotel2','comment1_hotel2','payment2_hotel2','paymet2_date_hotel2','mop2_hotel2','comment2_hotel2',
        ...
        'payment3_transport1','paymet3_date_transport1','mop3_transport1','comment3_transport1','payment4_transport1','paymet4_date_transport1','mop4_transport1','comment4_transport1','duet1'
        ,'payment1_transport2','paymet1_date_transport2','mop1_transport2','comment1_transport2','payment2_transport2','paymet2_date_transport2','mop2_transport2','comment2_transport2',
...
class ItineraryForm(forms.ModelForm):
    class Meta:
        model=Itinerary
        fields=('phone','name','location','days','person','category','hotel_type','meal_type','vehicle','other_inclusion','start_loc','end_loc'
                 ,'days1','days2','days3','days4','days5','days6','days7','days8','days9','days10','days11','days12','textdays1','textdays2','textdays3','textdays4','textdays5','textdays6','textdays7','textdays8','textdays9','textdays10','textdays11','textdays12','hotel_location1',
...
class UpdateItineraryForm(forms.ModelForm):
    class Meta:
        model=Itinerary
        fields=('days','person','category','hotel_type','meal_type','vehicle','other_inclusion','start_loc','end_loc'
                 ,'days1','days2','days3','days4','days5','days6','days7','days8','days9','days10','days11','days12','textdays1','textdays2','textdays3','textdays4','textdays5','textdays6','textdays7','textdays8','textdays9','textdays10','textdays11','textdays12','hotel_location1',
                 'hotel_location2','hotel_location3','hotel_location4','hotel_nights1','hotel_nights2','hotel_nights3','hotel_nights4','hotel_rooms1',
                 'hotel_rooms2','hotel_rooms3','hotel_rooms4','meal_type1','meal_type2','meal_type3','meal_type4','hotel_name1','hotel_name2',
                 'hotel_name3','hotel_name4','payment','payment_type','payment2','agent','agent_phone',)
...
class BlogForm(forms.ModelForm):
    class Meta:
        model=Blogpost
        fields=('title','head0','chead0','head1','chead1','head2','chead2','pub_date','thumbnail',)
